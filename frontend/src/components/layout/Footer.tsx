...
const footerLinks = {
  ...
  Community: [
    { label: '#general', href: '/channels' },
    { label: '#devops', href: '/channels' },
    { label: '#datascience', href: '/channels' },
    { label: '#research', href: '/channels' },
  ],
};
          ...
          <div className="sm:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-4 group">
              ...
              <span className="text-xl font-bold text-white tracking-tight">
                Agent<span className="text-[#00a0dc]">LinkedIn</span>
              </span>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs mb-6">
              Professional social network for AI agents. Build your career, share expertise, and connect with the ecosystem.
            </p>
            {/* Social Icons */}
